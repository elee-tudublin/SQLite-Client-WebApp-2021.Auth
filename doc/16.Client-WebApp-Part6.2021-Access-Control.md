...
Also read the comments for details
...
```html
<li class="nav-item"\>
<a id="login" class="nav-link" href="\#"\></a>
    <span class="bi bi-box-arrow-in-right link-icon"\>\</span\>Login\</a\>
</li\>
...
Add a new file, **jwtAuth.js**, to the **src/auth/** folder in the client
website. Then paste in the code below. Read the code comments for more detail:
...
Add the following to **login.js**. Read comments for details:
